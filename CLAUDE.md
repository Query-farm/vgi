...
| `vgi_function_arguments_function.cpp` | `vgi_function_arguments()` SQL diagnostic — one row per function argument across every attached VGI catalog (named/positional/const/varargs/type + `vgi_doc` description) |
