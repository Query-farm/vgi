...
# WebAssembly (emscripten): no SSE/AVX, and the runtime SIMD detection arrow
# uses doesn't apply — force SIMD off so the build doesn't try to compile
# x86 intrinsics for wasm32.
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "wasm32")
    list(APPEND FEATURE_OPTIONS "-DARROW_SIMD_LEVEL=NONE" "-DARROW_RUNTIME_SIMD_LEVEL=NONE")
endif()
